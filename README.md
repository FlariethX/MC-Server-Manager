...
![status](https://img.shields.io/badge/platform-Windows-e070ff?style=plastic) build.bat  
![status](https://img.shields.io/badge/platform-MacOS-e070ff?style=plastic) build.sh
